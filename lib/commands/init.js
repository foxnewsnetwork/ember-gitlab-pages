...
module.exports = {
  ...
  run: function(options, rawArgs) {
    ...
    function getCurrentBranchName() {
      return runCommand("git rev-parse --abbrev-ref HEAD", execOptions)
        .then(function(name) { currentBranch = name; });
    }
    ...
    function returnToPreviousCheckout() {
      return runCommand('git checkout ' + currentBranch, execOptions);
    }

    return getCurrentBranchName()
      .then(createOrphanPages)
      .then(removeTrash)
      .then(addAndCommit)
